...
function ThemeToggle() {
    ...
    if (!mounted) return <div className="w-13 h-7" />;
    ...
    return (
        <button
            type="button"
            role="switch"
            data-theme-toggle-custom=""
            aria-checked={isDark}
            aria-label="Toggle theme"
            onClick={handleToggle}
            className={cn(
                "relative inline-flex h-8 w-13 shrink-0 cursor-pointer rounded-lg border-2 border-transparent transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring bg-muted",
            )}
        >
            <span
                className={cn(
                    "pointer-events-none flex h-7 w-6 items-center justify-center rounded-lg bg-background shadow-sm ring-0 transition-transform duration-200",
    ...
    return (
        <nav
            className={cn(
                ...
                isHomePage && isScrolled ? "w-[min(80rem,95vw)] top-3" : "w-full rounded-none top-0",
            )}
            style={{
                ...
                <div className="flex items-center gap-1">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-0.5">
                            <kbd className="h-5 px-1.5 rounded border bg-background font-mono text-[10px] flex items-center">
                                Ctrl
                            </kbd>
                            <kbd className="h-5 px-1.5 rounded border bg-background font-mono text-[10px] flex items-center">
                                K
                    ...
                    <Button
                        ...
                        className="text-muted-foreground hover:text-indigo-400 transition-colors rounded-lg"
                    >
